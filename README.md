...
[![](./media/3x-ui.svg)](https://github.com/MHSanaei/3x-ui/releases)
[![](./media/release.yml.svg)](#)
[![GO Version](./media/go_version.svg)](#)
[![Downloads](./media/total.svg)](#)
[![License](./media/license-GPL%20V3-blue.svg)](https://www.gnu.org/licenses/gpl-3.0.en.html)

> **Disclaimer:** 此项目仅供个人学习交流，请不要用于非法目的，请不要在生产环境中使用。

**如果此项目对你有用，请给一个**:star2:

<p align="left"><a href="#"><img width="125" src="./media/296689912-7aa895dd-048a-42e7-989b-afd41a74e2e1.png" alt="Image"></a></p>
...
（最新版本号请自行到原始项目地址'''https://github.com/MHSanaei/3x-ui'''获取，并替换命令末尾的“vx.x.x”）
...
wget https://github.moeyy.xyz/https://github.com/MHSanaei/3x-ui/releases/latest/download/x-ui-linux-${XUI_ARCH}.tar.gz
```
...
2. 克隆仓库：
   ...
   ```sh
   git clone https://github.moeyy.xyz/https://github.com/MHSanaei/3x-ui.git
   cd 3x-ui
   ```
...
**1.** 在 **SOCKS Proxy Mode** 模式中安装Wrap
   ...
   ```sh
   bash <(curl -sSL https://github.moeyy.xyz/https://raw.githubusercontent.com/hamid-gh98/x-ui-scripts/main/install_warp_proxy.sh)
   ```
